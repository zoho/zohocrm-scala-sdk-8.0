...
class Data extends Record with Model	{
	...
	def getContactRole() :Option[ContactRole]	={
		return  this.getKeyValue("Contact_Role").asInstanceOf[Option[ContactRole]]
	}

	def setContactRole( contactRole: Option[ContactRole]) 	={
