...
class ModuleFields extends Fields with Model	{
	...
	private var autoNumber65:Option[AutoNumber] = None
	...
	def getAutoNumber65() :Option[AutoNumber]	={
		return  this.autoNumber65
	}

	def setAutoNumber65( autoNumber65: Option[AutoNumber]) 	={
	...
	override def getHistoryTrackingEnabled() :Option[Boolean]	={
		return  this.historyTrackingEnabled
	}

	override def setHistoryTrackingEnabled( historyTrackingEnabled: Option[Boolean]) 	={
