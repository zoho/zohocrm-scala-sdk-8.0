...
import com.zoho.crm.api.attachments.{ActionHandler, ActionResponse, ActionWrapper, APIException, AttachmentsOperations, FileBodyWrapper, SuccessResponse}
...
object UploadAttachments {
  ...
  @throws[Exception]
  private def uploadAttachments(): Unit = {
    val module = "Leads"
    ...
    val response: Option[APIResponse[ActionHandler]] = attachmentsOperations.uploadAttachments(recordId, module, fileBodyWrapper)
    response match {
