...
object DeleteAttachment {
  ...
  @throws[Exception]
  private def deleteAttachment(): Unit = {
    val module = "Leads"
    ...
    val response: Option[APIResponse[ActionHandler]] = attachmentsOperations.deleteAttachment(attachmentId, recordId, module)
    response match {
        ...
        if (apiResponse.isExpected) {
          ...
          responseHandler match {
            case actionWrapper: ActionWrapper =>
              val actionResponses = actionWrapper.getData().toList
