...
object GetAssociatedContactRolesSpecificToContact {

  @throws[Exception]
  private def getAssociatedContactRolesSpecificToContact(): Unit = {
    ...
    val response: Option[APIResponse[ResponseHandler]] = dealContactRolesOperations.getAssociatedContactRolesSpecificToContact(contactId, dealId)
  ...
  def main(args: Array[String]): Unit = {
    try {
      ...
      getAssociatedContactRolesSpecificToContact()
    } catch {
