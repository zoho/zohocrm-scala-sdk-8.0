...
object DeleteRecordUsingExternalId {

  @throws[Exception]
  private def deleteRecordUsingExternalId(moduleAPIName: String, externalFieldValue: String): Unit = {
    ...
    val response: Option[APIResponse[ActionHandler]] = recordOperations.deleteRecordUsingExternalId(externalFieldValue, Option(paramInstance), Option(headerInstance))
  ...
  def main(args: Array[String]): Unit = {
    try {
      ...
      val externalFieldValue = "TestExternalLead11"
