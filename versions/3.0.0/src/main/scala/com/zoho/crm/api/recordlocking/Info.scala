...
class Info extends Model	{
	private var call:Option[Boolean] = None
	...
	private var email:Option[Boolean] = None
	...
	def getCall() :Option[Boolean]	={
		return  this.call
	}

	def setCall( call: Option[Boolean]) 	={
		 this.call = call
	...
	def getEmail() :Option[Boolean]	={
		return  this.email
	}

	def setEmail( email: Option[Boolean]) 	={
		 this.email = email
