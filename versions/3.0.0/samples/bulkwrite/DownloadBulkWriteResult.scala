...
import com.zoho.crm.api.bulkwrite.{APIException, BulkWriteOperations, FileBodyWrapper, ResponseHandler}
import com.zoho.crm.api.dc.INDataCenter
import com.zoho.crm.api.dc.DataCenter.Environment
import com.zoho.crm.api.util.APIResponse

object DownloadBulkWriteResult {

  private def downloadBulkWriteResult(): Unit = {
    val downloadUrl = "https://download-accl.zoho.in/v2/crm/6020/bulk-write/10747001/105580001.zip" // Replace with actual download URL
    val destinationFolder = "./" // Replace with actual destination folder
    val bulkWriteOperations = new BulkWriteOperations()

    val response: Option[APIResponse[ResponseHandler]] = bulkWriteOperations.downloadBulkWriteResult(downloadUrl)
