...
object GetRelatedLists {

  @throws[Exception]
  private def getRelatedLists(): Unit = {
    val relatedListsOperations = new RelatedListsOperations()
    val paramInstance = new ParameterMap()
    paramInstance.add(new GetRelatedListsParam().module, "Leads")
    
    val response: Option[APIResponse[ResponseHandler]] = relatedListsOperations.getRelatedLists(Option(paramInstance))
