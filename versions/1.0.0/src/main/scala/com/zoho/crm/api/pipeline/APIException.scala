...
class APIException extends Model with TransferPipelineActionResponse with ActionResponse with ResponseHandler with ActionHandler with TransferPipelineActionHandler	{
