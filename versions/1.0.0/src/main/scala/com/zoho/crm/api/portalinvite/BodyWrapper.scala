...
class BodyWrapper extends Model	{
	private var portalInvite:ArrayBuffer[PortalInvite] = _
	private var keyModified:HashMap[String, Int] = HashMap()

	def getPortalInvite() :ArrayBuffer[PortalInvite]	={
		return  this.portalInvite
	}

	def setPortalInvite( portalInvite: ArrayBuffer[PortalInvite]) 	={
