...
class ResponseWrapper extends Model with ResponseHandler	{
	private var auditLogExport:ArrayBuffer[AuditLogExport] = _
	private var keyModified:HashMap[String, Int] = HashMap()

	def getAuditLogExport() :ArrayBuffer[AuditLogExport]	={
		return  this.auditLogExport
	}

	def setAuditLogExport( auditLogExport: ArrayBuffer[AuditLogExport]) 	={
