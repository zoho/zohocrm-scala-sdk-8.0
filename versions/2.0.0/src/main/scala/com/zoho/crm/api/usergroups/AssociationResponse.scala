...
class AssociationResponse extends Model	{
	private var type1:Option[String] = None
	private var resource:Option[Resource] = None
	private var detail:Option[AssociationModule] = None
	...
	def getDetail() :Option[AssociationModule]	={
		return  this.detail
	}

	def setDetail( detail: Option[AssociationModule]) 	={
		 this.detail = detail
