...
class APIException extends UnAssignedActionResponse with Model with ActionResponse with AssignedActionResponse with ResponseHandler with ActionHandler	{
